...
@Entity
@Table(name = "SERESC.SEAXAREAESTUDIOPROGRAMAOV")
public class SePaObtDatosTituloSelecHist implements java.io.Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -2927776460890303916L;
