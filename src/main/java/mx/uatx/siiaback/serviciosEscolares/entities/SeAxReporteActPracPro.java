...
@Entity
@Table(schema = "SERESC", name = "SEAXREPORTEACTPRACPRO")
public class SeAxReporteActPracPro implements Serializable {
    ...
    @SequenceGenerator(name = "GENID_REP_ACT_PP", sequenceName = "SERESC.IDREPACTPRACPRO", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GENID_REP_ACT_PP")
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SeAxReporteActPracPro)) {
            return false;
        }
        SeAxReporteActPracPro other = (SeAxReporteActPracPro) obj;
