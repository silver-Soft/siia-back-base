 ...
 */
@Entity
@Table(schema = "SERESC", name = "SEAXPERIODOSPRACTICAS")
public class SeAxPeriodosPracticasProfesionales implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@Basic(optional = false)
	@SequenceGenerator(name = "GENID_SEAXPERIODOSPRACTICAS", sequenceName = "SERESC.ID_SEAXPERIODOSPRACTICAS", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GENID_SEAXPERIODOSPRACTICAS")
	...
	public SeAxPeriodosPracticasProfesionales() {
	}
	...
	public void setIdSeAxPeriodosPracticas(Integer idSeAxPeriodosPracticas) {
		this.idSeAxPeriodosPracticas = idSeAxPeriodosPracticas;
	}
