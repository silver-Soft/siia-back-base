...
@Entity
public class SePaObtSeccionesAdmin {
	...
	@Column(name = "PERMITEPREGUNTAS")
	private Boolean blnPermitePreguntas;
	...
	public Boolean getBlnPermitePreguntas() {
		return blnPermitePreguntas;
	}

	public void setBlnPermitePreguntas(Boolean blnPermitePreguntas) {
		this.blnPermitePreguntas = blnPermitePreguntas;
	}
