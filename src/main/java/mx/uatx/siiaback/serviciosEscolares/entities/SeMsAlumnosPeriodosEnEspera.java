 ...
 */
@Entity
@Table(schema = "SERESC", name = "SEMSALUMNOSPERIODOSENESPERA")
public class SeMsAlumnosPeriodosEnEspera implements SeMsAlumnosPeriodosI, Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -4249707485963850266L;

	@Id
	@Basic(optional = false)
	@Column(name = "IDALUMNOPERIODO")
	@SequenceGenerator(name = "GENIDALUMNOPERIODOENESPERA", sequenceName = "SERESC.IDALUMNOPERIODO", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GENIDALUMNOPERIODOENESPERA")
