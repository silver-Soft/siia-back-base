...
@Entity
public class SiPaUsuariosDepYRec implements Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 272527400231277593L;
	...
	@Column(name = "PERMITEIMPRIMIRCREDENCIAL")
