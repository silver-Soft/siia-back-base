...
@Entity
@Table(schema = "SIIUAT", name="SIMSEVENTOSRECTOR")
public class SiMsEventosRector implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8709561524896612899L;
	@Id
	@Basic(optional = false)
	@SequenceGenerator(name = "IDEVENTORECTOR", sequenceName = "SIIUAT.IDEVENTORECTOR", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IDEVENTORECTOR")
    @NotNull
