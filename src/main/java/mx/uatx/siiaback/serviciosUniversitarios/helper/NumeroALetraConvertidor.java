...
public class NumeroALetraConvertidor implements Serializable {
	...
	private static final String[] UNIDADES_ACENTO = { "", "UN ", "D\u00d3S ", "TR\u00c9S ", "CUATRO ", "CINCO ", "S\u00c9IS ", "SIETE ",
			"OCHO ", "NUEVE ", "DIEZ ", "ONCE ", "DOCE ", "TRECE ", "CATORCE ", "QUINCE ", "DIECIS\u00c9IS ", "DIECISIETE ",
			"DIECIOCHO ", "DIECINUEVE ", "VEINTE " };
	 ...
	 */
	private NumeroALetraConvertidor() {
	}
