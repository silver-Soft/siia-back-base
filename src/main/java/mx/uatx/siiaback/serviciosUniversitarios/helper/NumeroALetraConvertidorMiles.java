...
public class NumeroALetraConvertidorMiles implements Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -4109532920112799061L;
	...
	private static final String[] UNIDADES_ACENTO = { "", "UNO ", "D\u00d3S ", "TR\u00c9S ", "CUATRO ", "CINCO ", "S\u00c9IS ", "SIETE ",
			"OCHO ", "NUEVE ", "DIEZ ", "ONCE ", "DOCE ", "TRECE ", "CATORCE ", "QUINCE ", "DIECIS\u00c9IS ", "DIECISIETE ",
			"DIECIOCHO ", "DIECINUEVE ", "VEINTE " };
	 ...
	 */
	private NumeroALetraConvertidorMiles() {
	}
	...
	private static String convertNumber(String number) {
		...
		if (k <= 20) {
			...
			output.append(DECENAS[getDigitAt(number, 1) - 2]).append("Y ").append(UNIDADES_ACENTO[getDigitAt(number, 0)]);
		} else {
			output.append(DECENAS[getDigitAt(number, 1) - 2]).append(UNIDADES_ACENTO[getDigitAt(number, 0)]);
		}
